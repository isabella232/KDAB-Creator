...
RemoteLinux::LinuxDeviceConfiguration::DeviceType BlackBerryDeviceConfigurationWizardSetupPage::deviceType() const
{
...
Utils::SshKeyGenerator *BlackBerryDeviceConfigurationWizardSshKeyPage::keyGenerator() const
{
    return m_keyGen;
}
...
{
    if (!m_keyGen)
        m_keyGen = new Utils::SshKeyGenerator;

    const bool success = m_keyGen->generateKeys(Utils::SshKeyGenerator::Rsa,
                                                Utils::SshKeyGenerator::Mixed, 4096,
                                                Utils::SshKeyGenerator::DoNotOfferEncryption);
