        ...
        const BlackBerryRunConfiguration *runConfig)
{
    ...
    if (runConfig->debuggerAspect()->useQmlDebugger()) {
        params.qmlServerAddress = runConfig->deployConfiguration()->deviceConfiguration()->sshParameters().host;
    ...
    BlackBerryQtVersion *qtVersion =
            static_cast<BlackBerryQtVersion *>(runConfig->activeQt4BuildConfiguration()->qtVersion());
