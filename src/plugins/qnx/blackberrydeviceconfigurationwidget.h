...
class BlackBerryDeviceConfigurationWidget : public RemoteLinux::ILinuxDeviceConfigurationWidget
{
    Q_OBJECT

public:
    explicit BlackBerryDeviceConfigurationWidget(const RemoteLinux::LinuxDeviceConfiguration::Ptr &deviceConfig,
                                          QWidget *parent = 0);
