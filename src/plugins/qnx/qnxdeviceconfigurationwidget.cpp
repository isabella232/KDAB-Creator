...
#include "qnxdeviceconfigurationwidget.h"
#include "ui_qnxdeviceconfigurationwidget.h"
...
QnxDeviceConfigurationWidget::QnxDeviceConfigurationWidget(
    ...
    ui(new Ui::QnxDeviceConfigurationWidget)
{
    ui->setupUi(this);
...
void QnxDeviceConfigurationWidget::hostNameEditingFinished()
{
...
void QnxDeviceConfigurationWidget::passwordEditingFinished()
{
    Utils::SshConnectionParameters sshParams = deviceConfiguration()->sshParameters();
...
void QnxDeviceConfigurationWidget::keyFileEditingFinished()
{
    Utils::SshConnectionParameters sshParams = deviceConfiguration()->sshParameters();
...
void QnxDeviceConfigurationWidget::showPassword(bool showClearText)
{
    ui->pwdLineEdit->setEchoMode(showClearText
        ? QLineEdit::Normal : QLineEdit::Password);
}

void QnxDeviceConfigurationWidget::setDefaultKeyFilePath()
{
    emit defaultSshKeyFilePathChanged(ui->keyFileLineEdit->path());
}

void QnxDeviceConfigurationWidget::debugTokenEditingFinished()
{
    deviceConfiguration()->setAttribute(QLatin1String(Constants::QNX_DEBUG_TOKEN_KEY), ui->debugToken->path());
}

void QnxDeviceConfigurationWidget::initGui()
{
