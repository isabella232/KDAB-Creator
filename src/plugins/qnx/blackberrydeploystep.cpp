...
bool BlackBerryDeployStep::immutable() const
{
    return false;
}
...
bool BlackBerryDeployStep::init()
{
    ...
    args << QnxUtils::addQuotes(QDir::toNativeSeparators(barPackage()));
...
void BlackBerryDeployStep::processStarted()
{
...
Qt4ProjectManager::Qt4BuildConfiguration *BlackBerryDeployStep::qt4BuildConfiguration() const
{
    return static_cast<Qt4ProjectManager::Qt4BuildConfiguration *>(target()->activeBuildConfiguration());
}


QString BlackBerryDeployStep::barPackage() const
{
