...
RemoteLinux::LinuxDeviceConfiguration::Ptr QnxDeviceConfigurationWizard::deviceConfiguration()
{
    ...
    RemoteLinux::LinuxDeviceConfiguration::Ptr devConf = RemoteLinux::LinuxDeviceConfiguration::create(m_setupPage->configurationName(),
        QLatin1String(Constants::QNX_QNX_OS_TYPE), RemoteLinux::LinuxDeviceConfiguration::Hardware,
        RemoteLinux::PortList::fromString(QLatin1String("10000-10100")), sshParams);
