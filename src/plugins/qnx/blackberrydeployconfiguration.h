...
class BlackBerryDeployConfiguration : public RemoteLinux::RemoteLinuxDeployConfiguration
{
    Q_OBJECT
    friend class BlackBerryDeployConfigurationFactory;

public:
    explicit BlackBerryDeployConfiguration(ProjectExplorer::Target *parent, const QString &proFilePath);
