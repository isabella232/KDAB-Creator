...
#ifndef QNX_INTERNAL_QNXCREATEPACKAGESTEPFACTORY_H
#define QNX_INTERNAL_QNXCREATEPACKAGESTEPFACTORY_H
...
class QnxCreatePackageStepFactory : public ProjectExplorer::IBuildStepFactory
{
    Q_OBJECT
public:
    explicit QnxCreatePackageStepFactory(QObject *parent = 0);
    ~QnxCreatePackageStepFactory();
...
#endif // QNX_INTERNAL_QNXCREATEPACKAGESTEPFACTORY_H
