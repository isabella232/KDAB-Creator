...
QnxRunConfiguration::QnxRunConfiguration(Qt4ProjectManager::Qt4BaseTarget *parent, const QString &proFilePath)
    : RemoteLinux::RemoteLinuxRunConfiguration(parent, QLatin1String(Constants::QNX_QNX_RUNCONFIGURATION_ID), proFilePath)
{
}

QnxRunConfiguration::QnxRunConfiguration(Qt4ProjectManager::Qt4BaseTarget *parent, QnxRunConfiguration *source)
